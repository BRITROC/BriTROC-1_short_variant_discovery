...
generate_somatic_oncoprint = function(somatic_variants, somatic_oncoprint_output_file, gene_set_analysed) {
	...
	somatic_variants$variant_type = somatic_variants$variant_type %>% as.character()
	somatic_variants$variant_type = 
		dplyr::if_else(
		somatic_variants$gene_symbol!='TP53' & somatic_variants$variant_type %in% c('missense','splice region SNV'),
		'no mutation',
		somatic_variants$variant_type,
		somatic_variants$variant_type
	)
	...
	somatic_variants$gene_symbol = somatic_variants$gene_symbol %>% as.character()
	somatic_variants$patient_id = somatic_variants$patient_id %>% as.character()
	...
	somatic_variants$gene_symbol = factor(
		somatic_variants$gene_symbol,
		levels=rev(c('TP53','BRCA1','BRCA2','BRIP1','BARD1'))
	)
