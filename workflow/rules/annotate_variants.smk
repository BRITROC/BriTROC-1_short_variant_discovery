...
rule vep_octopus:
	input:
		'results/tumour_sample_vcfs_octopus/{sample}.filtered2.vcf'
...
rule collate_and_filter_archival_octopus_vep_files:
	input: expand('results/tumour_sample_vcfs_octopus/{sample}.filtered.vep.vcf', sample=somatic_tp53_archival_samples)
