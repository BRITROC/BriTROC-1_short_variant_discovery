rule vep_octopus:
	input:
		'results/tumour_sample_vcfs_octopus/{sample}.filtered5.vcf'
...
rule collate_and_filter_archival_octopus_vep_files:
	...
	output: 'results/filtered_archival_vep_calls_octopus_non_tp53.tsv'
	script: '../scripts/collate_and_filter_vep_files_non_tp53.R'
