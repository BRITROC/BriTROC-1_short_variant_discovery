...
rule collate_and_filter_tumour_type_specific_vcf_files_with_tumour_type:
	...
	output: 'results/variant_analysis/unmatched/paired/collated/{tumour_type}_filtered3_joined.tsv'
	script: '../../../scripts/annotate_variants_joined/filtered4_files_joined.R'

rule MTBP_filter_curated_results_tumour_type_specific:
	input: rules.collate_and_filter_tumour_type_specific_vcf_files_with_tumour_type.output
	output: 'results/variant_analysis/unmatched/paired/collated/{tumour_type}_filtered3_joined_MTBP_filtered.tsv'
...
rule collate_and_filter_octopus_vep_files_with_tumour_type:
	input:
		...
		vcf_file=rules.MTBP_filter_curated_results_tumour_type_specific.output
	output:
		vep_output='results/variant_analysis/unmatched/paired/collated/{tumour_type}_filtered_vep_calls_octopus_joined.tsv',
		vep_reduced='results/variant_analysis/unmatched/paired/collated/{tumour_type}_BriTROC-1_unmatched_and_paired_variants.tsv',
		vcf_output='results/variant_analysis/unmatched/paired/collated/{tumour_type}_filtered_calls_octopus_joined.vcf'
