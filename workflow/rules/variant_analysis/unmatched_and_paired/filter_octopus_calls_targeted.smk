...
rule concat_vcfs_octopus_unmatched_targeted:
	input: 
		compressed_vcfs=lambda wildcards: expand('results/variant_analysis/unmatched/{analysis_type}/paired/{patient_id}.{nonoverlapping_id}.filtered2.targeted.vcf.gz', nonoverlapping_id=[1,2,3,4], patient_id=wildcards.patient_id, analysis_type=wildcards.analysis_type),
		compressed_vcf_indexes=lambda wildcards: expand('results/variant_analysis/unmatched/{analysis_type}/paired/{patient_id}.{nonoverlapping_id}.filtered2.targeted.vcf.gz.csi', nonoverlapping_id=[1,2,3,4], patient_id=wildcards.patient_id, analysis_type=wildcards.analysis_type)
