rule filter_octopus_raw_calls_targeted:
	...
	output: 'results/variant_analysis/unmatched/paired/{patient_id}.{nonoverlapping_id}.filtered.targeted.vcf'
...
rule filter_calls2_targeted:
	...
	output: 
		tumour_vcf='results/variant_analysis/unmatched/paired/{patient_id}.{nonoverlapping_id}.filtered2.targeted.vcf',
	threads: 4
...
rule bgzip_vcf_targeted:
	...
	output: 
		compressed_vcf=temp('results/variant_analysis/unmatched/paired/{patient_id}.{nonoverlapping_id}.filtered2.targeted.vcf.gz')
...
rule index_compressed_vcf_targeted:
	...
	output: 'results/variant_analysis/unmatched/paired/{patient_id}.{nonoverlapping_id}.filtered2.targeted.vcf.gz.csi'
	shell: '/home/bioinformatics/software/bcftools/bcftools-1.10.2/bin/bcftools index {input}'

rule concat_vcfs_targeted:
	input: 
		compressed_vcfs=lambda wildcards: expand('results/variant_analysis/unmatched/paired/{patient_id}.{nonoverlapping_id}.filtered2.targeted.vcf.gz', nonoverlapping_id=[1,2,3,4], patient_id=wildcards.patient_id),
		compressed_vcf_indexes=lambda wildcards: expand('results/variant_analysis/unmatched/paired/{patient_id}.{nonoverlapping_id}.filtered2.targeted.vcf.gz.csi', nonoverlapping_id=[1,2,3,4], patient_id=wildcards.patient_id)
