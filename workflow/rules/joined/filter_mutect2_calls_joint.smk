...
rule filter_octopus_raw_calls:
	...
	output: 'results/tumour_sample_vcfs_octopus/{patient_id}.{nonoverlapping_id}.filtered.vcf'
...
rule filter_calls2:
	...
	output: 
		tumour_vcf='results/tumour_sample_vcfs_octopus/{patient_id}.{nonoverlapping_id}.filtered2.vcf',
	threads: 4
	params:
...
#	input: 
#		filtered_vcf='results/tumour_sample_vcfs_octopus/{patient_id}.filtered2.vcf',
#	output: 'results/tumour_sample_vcfs_octopus/{patient_id}.filtered3.vcf'
#	shell: '/home/bioinformatics/software/bcftools/bcftools-1.10.2/bin/bcftools view -f PASS {input} | sed "/bcftools/d" > {output}'
