...
if config['panel_28_only'] == True:
	...
	include: 'workflow/rules/panel_28_only/octopus_joint_panel_28_only.smk'
	include: 'workflow/rules/panel_28_only/annotate_variants_joined_panel_28_only.smk',
	include: 'workflow/rules/panel_28_only/generate_oncoprints_panel_28_only.smk'
